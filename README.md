...
- **圖片 + MP3 成片**：靜態畫面長度預設對齊音軌；**輸出畫幅依原圖長寬比**（1080p 級：短邊 1080、長邊上限 1920）
  - 例：16:9 → 1920×1080、9:16 → 1080×1920、3:4 → 1080×1440、4:3 → 1440×1080
- 調整合併順序（上移 / 下移）
- 可勾選「不要聲音」輸出無音軌影片
...
合併時會將各片段標準化為同一畫幅、30fps、H.264 + AAC：畫幅依第一段素材長寬比縮放（短邊約 1080、長邊不超過 1920），不再硬套 16:9／9:16。
